...
// NewParticipationRoleParam create a new registries.ParticipantRoleParam property. See [RFC-5545] ref for more info
...
func NewParticipationRoleParam(value registries.ParticipantRoleRegistry) ParticipationRoleParam {
	return &textParameter{
		ParamName: registries.ParticipantRoleParam,
