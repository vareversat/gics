...
func NewCalendar(
	...
	return &calendar{
		Begin:      properties.NewBlockDelimiterProperty(registries.BEGIN, properties.VCALENDAR),
		...
		End:        properties.NewBlockDelimiterProperty(registries.END, properties.VCALENDAR),
	}, nil
}
